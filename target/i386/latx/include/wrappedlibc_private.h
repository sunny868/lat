...
GO(c16rtomb, LFpWp)
GOW(c32rtomb, LFpup)
//GOW(calloc, pFLL) // TODO: double free or corruption (out)
...
GO(chroot, iFp)
GOW(clearenv, iFv)
//GO(clearerr, vFS) //TODO: io_convert
...
////GO(__clone, 
GOWM(clone, iFppipppp) //FIXME:gysun
GO(__close, iFi)
GOW(close, iFi)
//GOW(closedir, iFp) //corrupted size vs. prev_size
//GO(closelog, vFv)
////GO(__close_nocancel, 
//GO(close_range, iFuui)
GO(__cmsg_nxthdr, pFpp) // FIXME:
GO(confstr, LFipL)
...
//GO(free, vFp) //TODO: corrupted size vs. prev_size
//GO(freeaddrinfo, vFp)
//GOW(freeifaddrs, vFp)
GO(__freelocale, vFp)
GOW(freelocale, vFp)
...
GOW(open_tree, iFipu)
////GO(__open_catalog, 
//GOW(opendir, pFp) //double free or corruption (out)
GO(openlog, vFpii)
...
////GO(__strcspn_c3, 
//GO(__strdup, pFp)
//GOW(strdup, pFp) // FIXME: double free
//GO(strerror, pFi)
